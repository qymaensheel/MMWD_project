...
def showMean():
    ...
    plt.ylabel("quality")
    plt.xlabel("growing population")        #liczbaworkerow
    plt.scatter(workers_count, pmeans)       #tablica ilosci workerow
